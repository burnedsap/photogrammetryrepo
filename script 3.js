$(document).ready(function() {
  ...
  var TITLE = 'Geekbench Single Core';
...
//  var POINT_RADIUS = 5; // radius of each data point
  ...
  d3.csv('data.csv').then(function(rows) {
    ...
    var ctx = document.getElementById('container 3').getContext('2d');
          ...
          callbacks: {
            ...
            label: function(tooltipItem, all) {
              return [
                ...
                'Single Core' + ': ' + POINT_Y_PREFIX + tooltipItem.yLabel.toLocaleString() + POINT_Y_POSTFIX,
